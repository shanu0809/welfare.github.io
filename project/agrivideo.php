...
<section class="my-5">
  <div class="py-5" id="service">
    <h2 class="text-center">Agriculture Related Videos</h2>
  </div>
...
<div class="card-deck text-center">
    <?php
    $sql = "SELECT * FROM  training WHERE field='Agriculture' OR field='agriculture'";
...
if ($result->num_rows > 0) {
          ...
          while($row = $result->fetch_assoc()) {
            ?>
              ...
              <div class="col-lg-4 col-md-4 col-12" style="overflow-wrap: break-word;overflow: hidden;padding: 5px;margin-left: 10px;width: auto;">
                <div class="row" style="padding: 5px;margin-left: 10px; ">
   <iframe style="width:560px;height: 315px;"  src="https://www.youtube.com/embed/<?php echo $row['videolink']; ?>" allowfullscreen></iframe><br>
    <h5 style="overflow-wrap: break-word;overflow: hidden;display: inline;"><b><?php echo  "Title : "?></b><?php echo $row['title'];?></h5>
    <br>
      <p style="overflow-wrap: break-word;overflow: hidden;display:inline;" align="left"><?php echo $row['des'];?><br>
      <b><?php echo "posted on : "?></b><?php echo $row['posttime'];
      ?>
      <br>
      <?php 
      if($row['link']==''){
        ...
        ?>
      <b><?php echo "Website : " ?></b><?php echo $row['link'];
}
      ?>
    </p>
    </div>
