...
<br>
<br>
<form class=""action="afterlogin.php" method="post" enctype="multipart/form-data" auto-complete="off">
	<div>
	<input type="text" name="username" class="inputbox" placeholder="Username" required></div><br>
	<div>
	<input type="password" name="password" class="inputbox" placeholder="Password" required></div><br>
		<div>
