...
<h2 align="center" style="overflow-wrap: break-word;overflow: hidden; padding-top: 5px;">Select the button !</h2>
<br>

 <div  align="center">    <a href="agrivideo.php">
 <button  onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Agriculture Related Courses/Important Videos</button></a></div><br>
  <div  align="center"> <a href="constructionvideo.php"><button onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Construction Related Courses/Important Videos</button></a></div><br>

   <div  align="center"> <a href="offlinetraining.php"><button onclick="document.getElementById('id03').style.display='block'" style="width:auto;">Offline Vocational Centers Details</button></a></div><br>
