...
?>
               ...
               <?php
                ...
                $sql = "SELECT * FROM training WHERE id='$idpic'";
   ...
   <div style="background-color: white; width:1000px; padding-left: 150px;">
        <div class="modal-content"style="background-color: white;">
            ...
            <div class="modal-body">
                <form  enctype="multipart/form-data" class="modal-content animate" action="finalupdatetrain.php" method="POST" autocomplete="off">
