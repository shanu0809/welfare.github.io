...
$avatar_path=mysqli_real_escape_string($conn,$avatar_path);
 ...
 $sql="UPDATE scheme  SET imagedoc='$avatar_path' WHERE id='$id'";
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                   ...
                   <form  enctype="multipart/form-data" class="modal-content animate" action="image.php"  method="POST" autocomplete="off">
...
$row=mysqli_fetch_assoc($result);
               if($row)
               {
                ...
                <div class="modal-footer">
                    ...
                    <a href="govt.php"><button type="button" class="btn btn-primary">No</button></a>
                </div>
            </form>
            </div>
        </div>
