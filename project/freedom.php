...
<h2 align="center"><b>Right To Freedom(Article 19-22)<b></h2>
                   <p>This right includes freedom of speech and expression, assembly, association, or union or cooperatives, movement, residence, and right to practice any profession or occupation.</p>
   </div>
    </section>
 <main role="main">
      ...
      <section class="jumbotron text-center"style="background: url('img/imagess(1).jpg'); background-size:cover">
        <div class="container">
            <?php
                ...
                $query = "select * from freedom";
                if(count(fetchAll($query))>0){
                    foreach(fetchAll($query) as $row){
                        ?>
          <div class="dark" style="background-color:#e7ee2c;color:#000000;overflow-wrap: break-word;overflow: hidden;">
  <ul>
